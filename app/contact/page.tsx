            ...
            <div className="bg-gradient-to-br from-[var(--card-bg)]/80 to-[var(--card-bg)]/40 backdrop-blur-sm
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 animate-children"
                ...
                {[
                  { 
                    name: "GitHub", 
                    url: "https://github.com/Kirusanth290", 
                    icon: "GitHub"
                  },
                  { 
                    name: "LinkedIn", 
                    url: "https://www.linkedin.com/in/kirusanth-palakanthan/", 
                    icon: "LinkedIn"
                  },
                  { 
                    name: "Instagram", 
                    url: "https://www.instagram.com/kirusanth.05/", 
                    icon: "Instagram"
                  },
                  { 
                    name: "Email", 
                    url: "mailto:kirusanthpalakanthan5@gmail.com", 
                    icon: "Email"
                  },
                ].map((social, i) => (
                  <a
